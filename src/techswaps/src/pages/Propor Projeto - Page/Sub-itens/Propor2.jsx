...
import { TextField, ThemeProvider } from '@mui/material';import '@fontsource/roboto/300.css';
...
export default function ProporProjeto2() {
      ...
      <div className={classes.root}>
        ...
        <Box sx={{ minWidth: 1025 }}>
          <FormControl fullWidth>
            <InputLabel id="demo-simple-select-label-1">Sector</InputLabel>
            <Select
