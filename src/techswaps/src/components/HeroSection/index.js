...
import { HeroBg, HeroContainer, homeOne, Container, Texto, Titulo, Subtitulo, Imagem, Imagem2, Imagem3, Imagem4, Imagem5, StyledButton, StyledButtonDark } from './HeroElements'
